...
//var title = "T-Shirts";
//var quantity = 5;
//document.write (name + " ordered " + quantity + title + " on Ahmed Clothing store");
// <-------------------x----------------------------x-------------------------->
...
// var a = +prompt("Enter Radius of Circle","4");
// var b = 2 * (3.142 * a);
// var c =  3.142 * (a * a);

// alert("Radius of a Circle is "+a+"\n"+"\n" +"CircumFerence of a Circle is "+b+"\n"+"\n" +"Area of a Circle is "+c);
...
// Chapter 8-11 User Input And Conditional Statement

//Task1. Write a program that takes input a name from user & greet the user:

//var a = prompt("Enter your name");
// alert("Welcome " +a);

//Task2. Write a program to take input a number from user & display it’s multiplication table on your browser.
...
//Task3. Write a program to take “city” name as input from user. If user enters “Karachi”,
...
//Task 4. Write a program to take “gender” as input from user. If the user is male,
...
//Task 6. Write a program to take input max age & current age from user. If the current age is
//  less than or equal to max age, show the message “You are welcome”*/ 
...
//Task 7. Write a program to take input remaining fuel in car (in litres)from user.
...
//Task 10. Write a program to implement checkout process of a shopping cart system for
//  an e-commerce website. Take input from users, the following:
// a. Name of item1
// b. Name of item2
// c. Price of item 1
// d. Price of item 2
...
//Task 11. Guess game: Store a secret number (ranging from 1 to 10) in a variable.
...
//Task 12. Write a program to check whether the given number is divisible by 3.
...
//Task 13. Names & Total scores of two teams are taken as input. Write a program that shows
//  which team has won the game or show if there is a tie. (Team A or Team B) */
...
//Task 14. Take a string, a number and a Boolean in three variables. Write a program that checks
//  the type of variables & responds accordingly.
...
//Task 15. Write a program that checks whether the given input is an even number or an odd number. 
...
//Task 16. Weather in Karachi nowadays is too cool, write a program that takes temperature as
...
//Task 17. Write a program to create a calculator for +,-,*, / & % using if statements. Take the following input:
// a. First number
// b. Second number
// c. Operation (+, -, *, /, %)
...
//Task 18. Write a program that takes user input day name. If the day is Monday, Tuesday, Wednesday,
//  Thursday or Friday, then show “It’s a week day”. If the day is Saturday then show “It’s
...
//tASK 19. Write a program that takes input user’s score, if it’s greater than 50,
//     say “You are passed”. Otherwise, show “Try again!” */
...
//Task 23. The Pluralizer: Write a program that:
...
// Chapter 12-13 If ELse, Else If Statements:
